...
Deux regles imposees a tout contenu textuel injecte dans une presentation :
...
``clean()`` est applique au plus bas niveau (chaque run de texte natif et chaque
primitive de texte Pillow) : tout texte produit par le moteur est ainsi
systematiquement nettoye, quelle que soit sa source (spec JSON, adaptateur
texte ou appels directs de l'API).
"""
